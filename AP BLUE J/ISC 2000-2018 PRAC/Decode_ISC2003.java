        ...
        else
        {
            ...
            else
            {
                ...
                for(int i=0; i<l; i++) {
                    ...
                    ch2 = s.charAt(i+1);// extracting the next character * Below we are adding shift value to the characters *if ch1="A" and shift = 7, * then ch1 + shift - 1 will give us: 'A'+7-1 = 65+7-1 = 71 * which is the ASCII value of 'G' *
                    ...
                    if((char)a == 'Q' && (char)b == 'Q') { a = 32; i++; } //* If ASCII value after adding the shift becomes more than 90, * then we subtract 26 from it, to make it circular, * eg. 'U'+7-1 = 85+7-1 = 91, but we want 'A' whose ASCII value is 65 * so 91-26 will give us 65 * 
                    if(a>90)
                        a = a - 26;
                    if(ch1 != ' ')
